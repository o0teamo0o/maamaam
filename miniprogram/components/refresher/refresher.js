...
const $stopRefresher = (selector = '#refresher', ctx) => getCtx(selector, ctx).finishPullToRefresh()
const $stopRefreshLoader = (selector = '#refresher', ctx, isEnd) => getCtx(selector, ctx).finishLoadmore(isEnd)
